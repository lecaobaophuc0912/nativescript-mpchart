...
declare function getfh(p1: string, p2: interop.Pointer | interop.Reference<fhandle>): number;
...
interface ucred {
	cr_link: { le_next: interop.Pointer | interop.Reference<ucred>; le_prev: interop.Pointer | interop.Reference<interop.Pointer | interop.Reference<ucred>>; };
	cr_ref: number;
	cr_posix: posix_cred;
