...
declare class BarChartDataEntry extends ChartDataEntry {
	...
	constructor(o: { x: number; yValues: NSArray<number>; data: any; });

	constructor(o: { x: number; yValues: NSArray<number>; icon: UIImage; });

	constructor(o: { x: number; yValues: NSArray<number>; icon: UIImage; data: any; });
	...
	initWithXYValuesData(x: number, yValues: NSArray<number>, data: any): this;

	initWithXYValuesIcon(x: number, yValues: NSArray<number>, icon: UIImage): this;

	initWithXYValuesIconData(x: number, yValues: NSArray<number>, icon: UIImage, data: any): this;
...
declare class ChartDataApproximator extends NSObject {
	...
	static reduceWithDouglasPeukerTolerance(points: NSArray<NSValue>, tolerance: number): NSArray<NSValue>;
}
...
declare class ChartIndexAxisValueFormatter extends NSObject implements IChartAxisValueFormatter {
	...
	static withValues(values: NSArray<string>): ChartIndexAxisValueFormatter;
	...
	constructor(o: { values: NSArray<string>; });

	class(): typeof NSObject;

	conformsToProtocol(aProtocol: any /* Protocol */): boolean;

	initWithValues(values: NSArray<string>): this;
...
declare class LineChartView extends BarLineChartViewBase implements LineChartDataProvider {
	...
	lineChartMaxXRange: number;

	lineChartMinXRange: number;
...
declare class YAxisRendererHorizontalBarChart extends ChartYAxisRenderer {
	...
	drawYLabelsWithContextFixedPositionPositionsOffset(context: any, fixedPosition: number, positions: NSArray<NSValue>, offset: number): void;
}
